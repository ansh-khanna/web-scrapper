...
import Filteration_Selective_2_1
...
def selective():
    ...
    # e1 label for Selective Number entry
    ...
    def cmd():
        if (len(e1.get()) == 0):
            ...
            if n <= 0:
                ...
                w.destroy()
                Filteration_Selective_2_1.selective_part_2(n)
    ...
    confirmbttn(100, 295, 'Confirm and Proceed', 'white', '#994422')
